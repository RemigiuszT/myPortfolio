    ...
    <div className="hero-banner-four text-center position-relative" id="s1">
      <div className="container">
        ...
        <div
          ...
          data-aos-delay="200"
        >
          Hi, I’m <span className="fw-500">Remigiusz Terek</span>
        </div>
        <div className="row">
          <div
          ...
          >
            <p className="text-lg pe-xxl-4 ps-xxl-4 mb-75 lg-mb-50">
              Front-End Developer specializing in React & TypeScript with
              commercial experience in SaaS products
            </p>
          </div>
        </div>
        <a
